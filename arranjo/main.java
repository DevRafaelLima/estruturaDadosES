...
class main{
    ...
    public static void main(String[] args){
        ...
        System.out.println("Aluno a2 está no array: "+tad.contem(a2));
        System.out.println("Aluno a3 está no array: "+tad.contem(a3));
        System.out.println("Aluno a5 está no array: "+tad.contem(a5));
        System.out.println("Aluno a6 está no array: "+tad.contem(a6));
        System.out.println("Aluno a7 está no array: "+tad.contem(a7));
        System.out.println("Aluno a8 está no array: "+tad.contem(a8));
        System.out.println("var x está no array: "+tad.contem(x));
        System.out.println("var texto está no array: "+tad.contem(texto));
        System.out.println("Novo tamanho: " + tad.tamanho());
        System.out.println("Aluno a4 está no array: "+tad.contem(a4));
        System.out.println("Novo tamanho: " + tad.tamanho());
        ...
        System.out.println("contém number: " + tad.contem(n1));
        System.out.println("Novo tamanho: " + tad.tamanho());
